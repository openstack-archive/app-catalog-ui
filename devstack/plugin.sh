...
function install_app-catalog-ui {
    ...
    sudo cp -a ${APP_CAT_UI_DIR}/app_catalog/static/dashboard/project/app_catalog ${DEST}/horizon/static/dashboard/project/
    sudo cp -a ${APP_CAT_UI_DIR}/enabled/* ${DEST}/horizon/openstack_dashboard/enabled/
    sudo python ${DEST}/horizon/manage.py compress
}
